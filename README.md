...
### Key Findings:
* **SSH (Port 22):** Open. Identified as a potential remote access point. Identifying the specific OS running on this port (Ubunto 2, Ubuntu 2.13) by running the -sV command allows for ruther investigation into potential vulnerabilities known to these versions.
